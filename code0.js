...
gdjs.IntroCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(16530700);
}
}}
}
...
gdjs.IntroCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(16532788);
}
}}
if (gdjs.IntroCode.condition1IsTrue_0.val) {
